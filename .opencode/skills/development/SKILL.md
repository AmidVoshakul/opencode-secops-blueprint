...
```
Use @senior-fullstack to set up a Next.js 15 project with App Router
```
...
#### Skills to Invoke
- `frontend-developer` - React/Next.js component development, UI/UX design implementation
- `react-patterns` - Modern React patterns
- `typescript-pro` - TypeScript best practices
- `tailwind-patterns` - Tailwind CSS styling
- `nextjs-app-router-patterns` - Next.js 15+ patterns
...
- `golang-backend-patterns` - Go/Gin/Echo/Fiber patterns
...
- `rust-pro` - Rust backend development
...
### Go/Gin Development
```
Skills: golang-backend-patterns
```
